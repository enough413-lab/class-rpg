...
insert into public.item_catalog(id,name,slot,boy_image,girl_image,price,active,default_owned,default_equipped) values
  ...
  ('magic-shoes-boy','남자 마법학교 신발','shoes','7.shoes/shoes_boy_magic.png','7.shoes/shoes_girl_magic.png',100,true,false,false),
  ('magic-shoes-girl','여자 마법학교 신발','shoes','7.shoes/shoes_boy_magic.png','7.shoes/shoes_girl_magic.png',100,true,false,false)
...
insert into public.shop_products(id,category,kind,name,description,icon,image,price,item_id,sort_order,gender) values
  ...
  ('magic-shoes-boy','shoes','wearable','남자 마법학교 신발','달과 별의 금빛 장식이 반짝이는 마법학교 운동화예요.','👟','7.shoes/shoes_boy_magic.png',100,'magic-shoes-boy',50,'boy'),
  ('magic-shoes-girl','shoes','wearable','여자 마법학교 신발','작은 리본과 달빛 장식이 어우러진 마법학교 운동화예요.','🎀','7.shoes/shoes_girl_magic.png',100,'magic-shoes-girl',60,'girl')
on conflict(id) do update set
